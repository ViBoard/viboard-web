        ...
        <b-navbar class="d-none d-lg-block" id="sidebar">
            <b-card id="register">
                ...
                <b-form>
                    ...
                    <b-form-group>
                        <b-form-input v-model="login_password" type="password" placeholder="Пароль" name="pswd"
                                      required/>
                    </b-form-group>
        ...
        <b-container fluid id="main">
            ...
            <b-row id="row2">
                ...
                <b-col>
                    ...
                    <p>
                        В 2014 основатели Reddit предположили, что их площадка будет улучшена, если часть доходов будет
                        возвращаться
                        пользователям. Схема распределения была непрозрачной, не вызывала доверия, и так и не была
                        принята
            ...
            <b-row id="row3">
                ...
                <b-col>
                    ...
                    <p>Монетизация через рекламу уходит в прошлое, теперь вам не придется видеть назойливые рекламные
                        вставки,
            ...
            <b-row class="d-lg-none">
                <b-card id="register2" title="Регистрация">
                    ...
                    <b-form>
                        <b-form-group>
                            <b-form-input v-model="login_username" type="text" placeholder="Логин" name="login"
                                          required/>
                        </b-form-group>
                        <b-form-group>
                            <b-form-input v-model="login_password" type="password" placeholder="Пароль" name="pswd"

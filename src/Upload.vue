            ...
            <b-col lg=8 offset-lg=2>
                <b-form>
                    <b-form-group label="Видео:">
                        <b-form-file @input="set_preview_url" placeholder="Выбрать файл..." id="video-file" type="file"
                                     v-model="videofile"/>
                    </b-form-group>
                    ...
                    <b-form-group v-if="show_previews_row" label="Превью:">
                        <div v-if="!preview_file_chosen">
                            <table>
                                <tr>
                                    <td v-for="i in n_previews" style="padding: 0.2em">
                                        <video
                                            :class="{'embed-responsive': true, 'focused': preview_frame_chosen == i - 1}"
                                            tabindex="0"
                                            :src="video_src"
                            ...
                            <div class="d-flex align-items-center" style="margin-top: 0.7em">
                                <b-button variant="outline-dark" @click="generate_previews(true)">Выбрать другие
                                </b-button>
                    ...
                    <b-button id="upload" v-if="!spinning" ref="upload" @click="upload" variant="dark"> Загрузить
                    </b-button>
                </b-form>
